...
#define TRACER_EMB_TX_DMA_IRQ                        DMA1_Channel2_IRQn
#define TRACER_EMB_TX_DMA_IRQHANDLER                 DMA1_Channel2_IRQHandler
#define TRACER_EMB_TX_DMA_ACTIVE_FLAG                LL_DMA_IsActiveFlag_TC2
#define TRACER_EMB_TX_DMA_CLEAR_FLAG                 LL_DMA_ClearFlag_TC2
